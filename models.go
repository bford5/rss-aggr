...
func dbFeedFollowToFeedFollow(dbFeedFollow database.FeedFollow) FeedFollows {
	return FeedFollows{
		ID:        dbFeedFollow.ID,
...
func dbFeedFollowsToFeedFollows(dbFeedFollows []database.FeedFollow) []FeedFollows {
